"""
Experiment 08 — Improved Ascore (adds GAMMA weight)
"""
import logging
from src.graphs import saas_pricing_graph
from src.orchestrator import DAGOrchestrator
from src.evaluators.exp_ascore_improved import process_node
...
def run():
    print("=" * 60)
    print("  Exp08: Improved Ascore — GAMMA weight added")
    print("=" * 60)

    graph = saas_pricing_graph()
    orchestrator = DAGOrchestrator(
        graph,
        store_path="state_exp08.json",
        process_fn=process_node,
    )

    logger.info("Starting Exp08 graph execution...")
